...
function App() {
  ...
  const fetchQuestions = (category = "", difficulty = "") => {            //questionList json'unun result'unu filtreliyoruz , filtrelediğimiz değişkenleri question olarak tanımladık
    ...
    <BrowserRouter>                       
      ...
      <Header /*başlık*/ />
        <Routes>
          ...
          ></Route>
          <Route path="/Admin"  /*Akademisyen giriş sayfası adminpanele bağlanıyor*/  element={<Admin />}></Route>
          <Route
            path="/Quiz"                      
            element={
          ...
          ></Route>
          <Route path="/Result" element={<Result name={name} score={score} category={category} difficulty={difficulty}/>}></Route>    
          <Route path="/AdminPanel" element={<AdminPanel name={name} score={score} category={category} difficulty={difficulty} />}></Route>
        </Routes>
      </div>
      <Footer /*altlık*/  />
    </BrowserRouter>
